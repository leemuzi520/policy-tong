...
window.ZCT_DATA.national.miit.push(
    ...
    conditions: [
      {
        ...
        items: [
          { name: "境内注册、独立法人", required: true, weight: 3, description: "42 号文申报条件（共性）：申报主体应在中华人民共和国境内注册，具有独立法人资格；表单四种企业类型均为依法设立的独立法人，此条件自动通过；未选类型时归为未核验", basis: { name: "42 号文申报条件（共性）", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" }, autoMatch: "type", rule: () => true },
          { name: "运营和财务状况良好", required: true, weight: 2, description: "42 号文申报条件（共性）：运营和财务状况良好；以近年度审计报告核实", basis: { name: "42 号文申报条件（共性）", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } },
          { name: "自 2021-01-01 至今无重大质量/环保/安全事故、无违法行为", required: true, weight: 3, veto: true, description: "42 号文申报条件（共性）：自 2021 年 1 月 1 日至今未发生重大质量、环保或安全事故，没有违法行为或涉嫌违法正在接受审查的情况；表单口径「近三年无重大事故（含经营异常/失信/重大违法违规）」与本条基本一致，选「有」从严判不满足", basis: { name: "42 号文申报条件（共性）", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" }, autoMatch: "accident", rule: v => v === "无" }
        ]
      },
      {
        category: "示范企业专项条件（42 号文）",
        items: [
          { name: "具有鲜明服务型制造特点的制造业企业", required: true, weight: 3, description: "42 号文示范企业申报条件：应为具有鲜明服务型制造特点的制造业企业；纯服务业企业、第三方平台不属于示范企业类别（平台走示范平台通道）", basis: { name: "42 号文示范企业申报条件", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } },
          { name: "服务收入占营业收入比重原则上 ≥30%", required: true, weight: 3, description: "42 号文示范企业申报条件：原则上服务收入占企业营业收入比重达 30% 以上（核心量化门槛）；表单无服务收入字段，需人工按统计/审计口径核实服务收入占比（含定制化服务、供应链管理、检验检测认证、全生命周期管理、总集成总承包、节能环保、生产性金融等模式收入）", basis: { name: "42 号文示范企业申报条件", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } },
          { name: "通过战略规划、组织保障、技术创新、流程再造等措施实现转型升级并取得显著成效", required: true, weight: 2, description: "42 号文示范企业申报条件：通过战略规划、组织保障、技术创新、流程再造等措施实现转型升级并取得显著成效；需提供转型举措与成效佐证材料", basis: { name: "42 号文示范企业申报条件", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } }
        ]
      },
      {
        category: "申报程序（42 号文，名额制）",
        items: [
          { name: "按属地名额参加遴选（省级初审择优推荐）", required: true, weight: 2, description: "42 号文推荐名额：示范企业——各省（区、市）及新疆生产建设兵团不超过 10 个、计划单列市不超过 3 个；示范平台——共享制造类各省 ≤1 个、其他类 ≤3 个；示范城市各 ≤1 个。属地工信部门先遴选，不是报了就评", basis: { name: "42 号文推荐名额", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } },
          { name: "在服务型制造公共服务平台线上填报且材料齐全", required: true, weight: 1, description: "42 号文申报程序：申报主体在服务型制造公共服务平台（selection.csoma.org.cn）注册并填报材料，通过省级初审后下载申报书并加盖公章，各省级主管部门于 2023 年 5 月 31 日前将申报汇总表、申报书（一式 1 份）报送工信部（产业政策与法规司）；示范城市材料由本级政府工信主管部门填报", basis: { name: "42 号文申报程序", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4140/post_4140407.html" } }
        ]
      },
      {
        category: "加分项（非硬性门槛）",
        items: [
          { name: "服务型制造创新模式典型（十大模式）", required: false, weight: 2, description: "42 号文遴选方向：定制化服务、供应链管理、检验检测认证服务、全生命周期管理、总集成总承包、节能环保服务、生产性金融服务及其他创新模式；101 号文第二条列举工业设计服务、定制化服务、供应链管理、共享制造、检验检测认证服务、全生命周期管理、总集成总承包、节能环保服务、生产性金融服务、其他创新模式十种", basis: { name: "42 号文遴选类别 · 101 号文第二条", url: "https://www.miit.gov.cn/jgsj/zfs/wjfb/art/2020/art_6e2411a497f34aabb9091dba3e542129.html" } },
          { name: "已获省级服务型制造示范认定", required: false, weight: 1, description: "广东省级服务型制造示范遴选 2024 年起持续开展（粤工信生产合作函〔2024〕2 号，2024-09-02 公布名单）；国家层面各批各地转发通知普遍优先推荐已获省级示范的企业（如海南、福建、深圳等 42 号文转发口径）", basis: { name: "粤工信生产合作函〔2024〕2 号 · 42 号文各地转发口径", url: "http://gdii.gd.gov.cn/gkmlpt/content/4/4393/post_4393707.html" } },
          { name: "深化数字化与工业互联网应用", required: false, weight: 1, description: "2025—2028 实施方案任务七：深化「5G+工业互联网」融合应用，按需布局算力基础设施，推动人工智能技术与服务型制造融合创新；任务六：打造 100 个服务型制造创新发展高地（以省级及以上高新区、工业园区、产业集群为载体先行先试）", basis: { name: "2025—2028 实施方案（任务六、任务七）", url: "https://app.www.gov.cn/govdata/gov/202510/11/538265/article.html" } }
        ]
      }
    ],
  ...
  },
  {
    ...
    conditions: [
      {
        ...
        items: [
          { name: "境内注册、独立法人", required: true, weight: 3, description: "476 号通知申报基本条件（一）：申报主体为企事业单位的，应在中华人民共和国境内注册，具备独立法人资格；表单四种企业类型均为依法设立的独立法人，此条件自动通过；未选类型时归为未核验", basis: { name: "476 号通知申报基本条件（一）", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" }, autoMatch: "type", rule: () => true },
          { name: "近三年财务状况良好", required: true, weight: 2, description: "476 号通知申报基本条件（一）：近三年财务状况良好；以近三年审计报告/财务报表核实", basis: { name: "476 号通知申报基本条件（一）", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" } },
          { name: "近三年无重大违法违规行为、未发生较大及以上生产安全事故和环境污染事故", required: true, weight: 3, veto: true, description: "476 号通知申报基本条件（一）：近三年无重大违法违规行为、未发生较大及以上生产安全事故和环境污染事故；表单口径「近三年有无重大安全/环保/质量事故（含经营异常/失信/重大违法违规）」与本条基本一致，选「有」从严判不满足", basis: { name: "476 号通知申报基本条件（一）", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" }, autoMatch: "accident", rule: v => v === "无" },
          { name: "案例符合国家法律法规及相关政策要求、可对外公开", required: true, weight: 1, description: "476 号通知申报基本条件（三）：案例应重点突出、表述准确、资料翔实，符合国家有关法律法规及相关政策要求，可对外公开", basis: { name: "476 号通知申报基本条件（三）", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" } }
        ]
      },
      {
        category: "案例要求（476 号（二）+ 300 号（二）原文口径）",
        items: [
          { name: "案例已落地并取得成效、实施效果显著、带动作用强", required: true, weight: 3, description: "300 号通知申报条件（二）：应用案例须已落地并取得成效，在物联网融合应用中取得创新性突破，实施效果显著，带动作用强；河北转发附件 4 口径：须已落地并取得成效，能充分体现物联网的技术特点，高度聚焦实际场景应用需求和重点问题，示范效应良好", basis: { name: "300 号通知申报条件（二）· 河北转发附件 4 口径", url: "https://gxt.hebei.gov.cn/sme/xmsb/2025122408510614445/index.html" } },
          { name: "案例具有较强代表性、创新性和可推广性", required: true, weight: 2, description: "476 号通知申报基本条件（二）：案例应具有较强的代表性、创新性和可推广性，对相关地区、行业、企业具有较强的借鉴意义和推广价值", basis: { name: "476 号通知申报基本条件（二）", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" } },
          { name: "案例属于 4 领域 14 个具体方向之一", required: true, weight: 3, description: "300 号通知（一）4 领域 14 方向原文：行业应用（智能制造/智慧农业/智慧物流/智慧能源/智能建造）、社会治理（智能交通/城市管理/绿色环保）、民生消费（智能网联汽车/智慧家居/智慧文旅/智慧健康）、与新产业融合（新兴产业：物联网与 5G、大数据、云计算、人工智能、区块链、卫星互联网等融合；未来产业：与元宇宙、脑机接口、量子信息、人形机器人、生物制造等融合）；2025 年度经 476 号附件 4 延续", basis: { name: "300 号通知（一）14 方向原文", url: "https://wap.miit.gov.cn/jgsj/kjs/wjfb/art/2024/art_9713399301944dcc8273339cec19e0af.html" } },
          { name: "案例未曾入围往年工信部物联网示范项目和典型案例", required: true, weight: 2, description: "300 号通知申报条件（二）：应用案例须未曾入围往年工业和信息化部物联网示范项目和典型案例（防重复申报）；往期已获评的企业以新案例申报", basis: { name: "300 号通知申报条件（二）", url: "https://wap.miit.gov.cn/jgsj/kjs/wjfb/art/2024/art_9713399301944dcc8273339cec19e0af.html" } }
        ]
      },
      {
        category: "申报程序（476 号（三）+ 300 号（三）+ 河北转发）",
        items: [
          { name: "按属地推荐单位审核推荐（省级工信主管部门/通信管理局）", required: true, weight: 2, description: "476 号通知征集程序：申报主体填写申报材料后报所在省、自治区、直辖市及计划单列市、新疆生产建设兵团工业和信息化主管部门以及各地通信管理局等推荐单位，由推荐单位审核、推荐并报送至部内相应主责司局；名额竞争（300 号口径）：各省 ≤10 项、计划单列市/新疆兵团/中央企业/部属单位 ≤5 项，无锡高新区、重庆南岸区、杭州高新区（滨江）、福州经开区、江西鹰潭五个物联网示范基地各可独立推荐 ≤5 项", basis: { name: "476 号通知征集程序 · 300 号通知（三）推荐数量", url: "https://www.miit.gov.cn/zwgk/zcwj/wjfb/tz/art/2025/art_529cd59e4e864dadb51d299d9d797315.html" } },
          { name: "在征集系统（www.iotproj.cesi.cn）线上填报且材料齐全", required: true, weight: 1, description: "河北转发（2025 年度）：申报单位登录申报平台（www.iotproj.cesi.cn）填写申报材料并加盖公章上传；300 号通知（三）申报流程：网上填报 + 纸质版材料报送结合，纸质版与线上填报内容一致", basis: { name: "河北转发平台要求 · 300 号通知（三）申报流程", url: "https://gxt.hebei.gov.cn/sme/xmsb/2025122408510614445/index.html" } }
        ]
      },
      {
        category: "加分项（非硬性门槛）",
        items: [
          { name: "案例已获省级/行业示范或典型案例认定", required: false, weight: 1, description: "各省转发通知普遍优先推荐已落地见效、示范效应良好的案例（如河北口径）；此前获省级案例/示范荣誉可作为佐证材料加分，非硬性条件（以当年度通知为准）", basis: { name: "河北转发附件 4 口径", url: "https://gxt.hebei.gov.cn/sme/xmsb/2025122408510614445/index.html" } },
          { name: "案例融入新一代信息技术融合创新（5G/大数据/AI/区块链等）", required: false, weight: 1, description: "300 号通知（一）新兴产业方向：聚焦物联网与 5G、大数据、云计算、人工智能、区块链、卫星互联网等新一代信息技术融合应用，征集促进新一代信息技术产业发展、形成新质生产力的案例", basis: { name: "300 号通知（一）新兴产业方向", url: "https://wap.miit.gov.cn/jgsj/kjs/wjfb/art/2024/art_9713399301944dcc8273339cec19e0af.html" } }
        ]
      }
    ],
    ...
    changes: [
      ...
      "名额制（300 号（三）2024 年度口径）：各省 ≤10 项、计划单列市/新疆兵团/中央企业/部属单位 ≤5 项；无锡高新区、重庆南岸区、杭州高新区（滨江）、福州经开区、江西鹰潭五个物联网示范基地可独立推荐 ≤5 项；2025 年度名额以当年通知为准",
      "无中央资金奖补；申报全程免费（476 号工作要求：不得向申报主体收取任何费用），不得多头重复报送材料"
    ],
    tips: "这是工信部「案例荣誉」类政策：无中央直接奖补，价值在国家级典型案例背书与政策服务支持（299 号通知明确要求各地在技术创新、应用落地、政府服务等方面对入选案例加大支持力度、推动优秀成果规模化应用）。三点入门认知：①门槛不高但竞争性甄选——基础合规（境内独立法人、近三年财务状况良好、无重大违法违规及较大以上安全环保事故）+ 案例要求（已落地并取得成效、属于 4 领域 14 个具体方向、未入围往年、每单位限报 1 项），先确认自己有已落地见效的物联网应用场景（设备互联、远程运维、能耗管控、智能巡检、智能计量等）再报；②四大领域 14 个方向对照自检——行业应用（智能制造/智慧农业/智慧物流/智慧能源/智能建造）、社会治理（智能交通/城市管理/绿色环保）、民生消费（智能网联汽车/智慧家居/智慧文旅/智慧健康）、与新产业融合（新兴产业/未来产业），案例须高度聚焦实际场景应用需求和重点问题、充分体现物联网技术特点；③流程与节奏——年度征集（2024 年 7-8 月、2025 年并入 11-12 月集中征集），征集系统（www.iotproj.cesi.cn）线上填报 + 属地省级工信主管部门审核推荐（名额竞争），名单次年公布，留意属地转发通知。⚠️ 申报全程免费（476 号工作要求），谨防不良中介以「名额费/申报费」名义收费；工信部不委托任何机构代理申报。"
  }
);
