...
window.ZCT_DATA.guangdong.push(
  ...
  },
  {
    ...
    level: "省级",
    deadline: "银行经办、按季度申报：贴息期 2025-05-01 至 2027-12-31（期间发放的贷款）；经办银行每季度结束后 10 个工作日内申报、名单公示 7 个工作日、省金融管理局按季度预拨 80%（粤金管〔2025〕15号第十四条、第十三条）；2026-05-20 起按粤金管〔2026〕12号优化口径执行（至 2027-12-31 截止）",
    effort: "Easy",
    updated: "2026-08-15",
    source: { name: "《广东省制造业和高新技术企业贷款贴息实施细则》（粤金管〔2025〕15号，2025-07-31 印发）+ 《关于优化全省制造业和高新技术企业贷款贴息政策的通知》（粤金管〔2026〕12号，2026-05-20 印发，现行口径）", url: "https://www.gdjr.gov.cn/gdjr/zwgk/tzgg/content/mpost_38655.html" },
    notice: { name: "粤金管〔2026〕12号《关于优化全省制造业和高新技术企业贷款贴息政策的通知》（2026-05-20 印发，央地叠加新口径）", url: "https://www.gdjr.gov.cn/gdjr/zwgk/tzgg/content/post_43242.html", timeline: "贴息期 2025-05-01 至 2027-12-31（期间经办银行发放的合格贷款）；12 号文（2026-05-20）优化：①央地政策叠加——2025-05-01 后享受中央设备更新贷款财政贴息、中央中小微企业贷款贴息等政策所对应的新发放贷款纳入全省贴息范围，同一笔贷款各级财政贴息合计不得超过利息支付总额；②经办银行新增江西银行/九江银行/长沙银行/厦门国际商业银行 4 家异地城商行及金融监管评级 3A 及以上外资银行；③年度总规模 2000 亿、先报先得额度用完即止；细则有关规定与 12 号文不一致的以 12 号文为准（至 2027-12-31 截止）；配套：工作指引（2025-09-26，gdjr.gov.cn/jrzx/gzdt/content/post_39290.html）+ 企业申报指南（2025-09-29，粤信服平台，post_39286.html）" },
    summary: "广东省制造业和高新技术企业贷款贴息（粤金管〔2025〕15号，6 部门联合，2025-07-31 印发；2026-05-20 起按粤金管〔2026〕12号优化口径执行）：对广东省内注册的制造业企业（工商登记 C 制造业）和有效期内高新技术企业，在 2025-05-01 至 2027-12-31 期间通过经办银行获得的合格贷款给予财政贴息。贴息标准：贴息金额 = 单笔放款本金 × 贷款年利率 × 35%（不足一年按实际付息天数折算）；单个企业年度贴息最高 2000 万元，单笔贷款合同可享受不超过 1 年贴息；省财政年度贴息对应贷款总规模控制在 2000 亿元以内（三年 6000 亿）、先报先得额度用完即止。贴息范围：新增银行贷款用于建设厂房、购买设备、技术改造、科技研发等；制造业企业贷款须为固定资产贷款、投向广东省辖内；高企主营业务须属于《产业结构调整指导目录（2024年本）》鼓励类，研发用途贷款总额不得超过企业上一年度「研究开发费用加计扣除」申报金额（工作指引）。负面清单：不得用于借新还旧、偿还股东借款或其他银行贷款、购地及非生产性固定资产投资、金融投资（理财/股票/虚拟货币）、购买个人房产/用车、房地产开发、城市改造、市政工程等。规则：企业同属制造业和高企的只能选一个领域申请；同一笔贷款只能选择一项省级贴息政策；央地叠加——2025-05-01 后享受中央设备更新贷款财政贴息、中央中小微企业贷款贴息等政策的新发放贷款可纳入全省贴息范围（12 号文一），同一笔贷款各级财政贴息合计不得超过利息支付总额；经办银行含 21 家全国性银行在粤分支机构、5 家地方城商行、广东各家农商银行 + 12 号文新增 4 家异地城商行与 3A 及以上外资银行。贴息由经办银行主导申报（企业向经办银行提交贴息申请书及承诺书），银行按季度向平台报送（季度结束后 10 个工作日内），名单公示 7 个工作日，省金融管理局预拨 80% 贴息、银行收息后 3 个工作日内拨付企业。深圳市自行制定贴息政策、不纳入本细则。",
    subsidy: "财政贴息：单笔放款本金 × 年利率 × 35%（按实际付息天数折算）；单企业年度最高 2000 万、单笔合同 ≤1 年；年度总规模 2000 亿、先报先得用完即止（粤金管〔2025〕15号第十二条 · 粤金管〔2026〕12号）",
    ...
    conditions: [
      ...
      },
      {
        ...
        items: [
          { name: "贷款在 2025-05-01 至 2027-12-31 期间由经办银行发放", required: true, weight: 3, description: "细则第二条、第十一条（一）：对经办银行在 2025-05-01 至 2027-12-31 发放的、符合贴息条件的贷款所产生的利息支出给予财政贴息；经办银行含 21 家全国性银行在粤分支机构、5 家地方城商行和广东各家农商银行（细则第六条），2026-05-20 起按 12 号文新增江西银行、九江银行、长沙银行、厦门国际商业银行 4 家异地城商行及金融监管评级 3A 及以上外资银行", basis: { name: "细则第二条、第六条、第十一条（一）· 12 号文二", url: "https://www.gdjr.gov.cn/gdjr/zwgk/tzgg/content/post_43242.html" }, evidence: "贷款合同与放款凭证（发放日期在贴息期内、经办银行在名单内）" },
          { name: "贷款用途合规：建设厂房/购买设备/技改/科技研发；制造业须固定资产贷款且投向省内", required: true, weight: 3, description: "细则第十一条（一）：新增银行贷款用于建设厂房、购买设备、技术改造、科技研发等方面；制造业企业贷款为固定资产贷款，贷款须投向广东省辖内；高企主营业务应属于《产业结构调整指导目录（2024年本）》鼓励类；工作指引细化：高企流动资金贷款用于技术改造的须取得备案（核准/审批）文件，用于科技研发的归集按高企认定工作指引执行", basis: { name: "细则第十一条（一）· 工作指引", url: "https://www.gdjr.gov.cn/gdjr/jrzx/gzdt/content/post_39290.html" }, evidence: "贷款合同用途条款 + 投向说明" },
          { name: "贷款用途不在负面清单内", required: true, weight: 2, description: "细则第十一条（三）负面清单制：贷款不得用于借新还旧、偿还股东借款或其他银行贷款（含过桥资金）、偿还其他债务、购买土地及非生产性固定资产投资、金融投资（理财/股票/虚拟货币等套利）、购买个人房产、个人用车、房地产开发、城市改造、市政工程等，不得用于投资国家产业政策禁止和限制的项目；逾期贷款利息、加息、罚息不纳入（工作指引）", basis: { name: "细则第十一条（三）· 工作指引", url: "https://www.gdjr.gov.cn/gdjr/jrzx/gzdt/content/post_39290.html" }, evidence: "资金用途合规自检说明" },
          { name: "同一笔贷款未申请其他省级贴息政策；央地贴息叠加须合计不超过利息总额", required: true, weight: 2, description: "细则第十二条（三）+ 12 号文一（央地叠加）：同一笔贷款符合省内不同贷款贴息政策条件的只能选择其中一项申请；2025-05-01 后享受中央设备更新贷款财政贴息、中央中小微企业贷款贴息等政策所对应的新发放贷款可纳入全省贴息范围（原「已享受中央设备更新再贷款贴息不再纳入」表述已被 12 号文调整），同一笔贷款在贴息年度内获得的各级财政贴息资金总额不得超过贷款利息支付总额", basis: { name: "细则第十二条（三）· 12 号文一", url: "https://www.gdjr.gov.cn/gdjr/zwgk/tzgg/content/post_43242.html" }, evidence: "贴息政策重叠情况自检说明（含中央贴息获得情况）" },
          { name: "高企研发用途贷款总额 ≤ 上年度加计扣除申报金额（工作指引）", required: true, weight: 2, description: "工作指引二（三）：高企研发用途贷款总额不得超过企业 2025 年季度企业所得税纳税申报表附表中「研究开发费用加计扣除」申报金额（预缴 A200000 第 7 行 / 汇缴 A100000 第 22 行）；用于科技人员工资的另附企业职工和科技人员情况说明（含近三个月社保证明）", basis: { name: "工作指引二（三）· 附表 2", url: "https://www.gdjr.gov.cn/gdjr/jrzx/gzdt/content/post_39290.html" }, evidence: "企业所得税纳税申报表（上一年度主表及附表）+ 研发归集说明" }
        ]
      },
      {
    ...
    // zct-diag 2026-08-15 深化：材料按三组收录（企业端申报 / 银行报送 / 贷款贴息审核佐证——细则第八条、第十四条附件 2-5 + 工作指引附表 1/2 + 申报指南）
    materials: [
      { name: "贴息申请书（企业版，附件 3，向经办银行提交或粤信服平台上传盖章件）", required: true, basis: { name: "细则第八条、第十四条 · 申报指南", url: "https://www.gdjr.gov.cn/gdjr/jrzx/gzdt/content/post_39286.html" } },
      { name: "承诺书（附件 2）", required: true },
      { name: "贴息申请书（银行版，附件 4）+ 贴息申请明细表（附件 5）", required: false, note: "银行端按季度报送材料（季度结束后 10 个工作日内），企业侧主要提供申请书与承诺书（细则第十四条（一））" },
      { name: "借款合同", required: true, note: "工作指引附表 1（固定资产贷款）7 项 / 附表 2（流动资金贷款）9 项审核佐证" },
      { name: "放款凭证或借据", required: true },
      { name: "采购发票 + 用款合同（企业提供）", required: true },
      { name: "贷款支付流水 + 企业出具的贷款使用说明（企业盖章）", required: true },
      { name: "企业营业执照 + 高企证书（按高企领域申请时）", required: true },
      { name: "科技研发相关证明材料（知识产权证书、科研项目立项证明、高新技术产品（服务）材料等）", required: false, note: "流动资金贷款（科技研发用途）另附：上一年度企业所得税纳税申报表（主表及附表）；用于科技人员工资的另附企业职工和科技人员情况说明（含近三个月社保证明）" }
    ],
    diagNotes: [
      "银行经办制：企业向经办银行提交贴息申请书及承诺书，由银行审核资质、贷款投向、资金使用及利息收支后按季度向平台申报（细则第八条、第十四条）；企业侧动作轻，关键是贷款发放时就与经办银行确认贴息资格",
      "线上申报（2025-09-29 企业申报指南）：电脑端——广东省统一身份认证平台注册 →「粤信服」企业用户登录 → 选择经办企业主体 → 贷款贴息登记（填报经办银行、合同编号、项目名称、贷款金额、合同有效期、申报类型、约定利率）→ 上传加盖公章的企业申请书、承诺书（PDF/图片，单个 ≤2M）提交 → 进度查询；移动端微信「粤信服」小程序 → 省补贴息 → 粤信签认证",
      "资金节奏：经办银行按季度报送（季度结束后 10 个工作日内），名单公示 7 个工作日，省金融管理局向经办银行省级分支机构预拨 80% 贴息，经办银行向客户收取利息之日起 3 个工作日内拨付企业、据实结算剩余 20%（细则第十三条、第十四条）——贴息到账快，随利息支付节奏走",
      "2026 优化（12 号文）：央地政策叠加——2025-05-01 后享受中央设备更新贷款贴息、中央中小微企业贷款贴息等的新发放贷款可纳入全省贴息范围，各级贴息合计不超过利息支付总额；经办银行新增 4 家异地城商行 + 3A 及以上外资银行；年度 2000 亿总规模先报先得、额度用完即止",
      "深圳市自行制定贷款贴息政策，该市辖内企业不纳入本细则贴息范围（细则第十九条）；防止政策重叠：同一笔贷款只能享受一项省级贴息政策；各级财政贴息合计不得超过利息支付总额（细则第十二条（三）、第十六条）"
    ],
    revisions: [
      { at: "2026-08-15", note: "新增收录（第 1 批政策扩充）：依据粤金管〔2025〕15号（2025-07-31 印发，6 部门联合），贴息资格/范围/标准/流程条件收录", basis: "粤金管〔2025〕15号" },
      { at: "2026-08-15", note: "zct-diag 深化：核源 12 号文（2026-05-20，央地叠加/经办银行扩充/先报先得）+ 工作指引（2025-09-26，附表 1/2 材料清单 + 高企研发贷款上限加计扣除金额）+ 企业申报指南（粤信服平台）——更新央地叠加口径、补充材料三组与线上流程、高企研发用途条件", basis: "粤金管〔2026〕12号 · 工作指引 · 申报指南" }
    ],
    tips: "这是广东 2025 年 7 月新上线的普惠贴息政策，覆盖面极广（制造业 + 高企都算），贴息率 35% 固定、单个企业一年最高 2000 万——比专精特新贴息（gdinterest，50%/100 万）门槛低得多，是「有贷款就能蹭」的政策。五个认知点：①银行主导——不用企业主动去政府申报，贷款发放时让经办银行确认贴息资格、提交贴息申请书+承诺书即可，放款后按季度自动滚动，也可在「粤信服」平台线上登记；②贷款用途必须合规——建厂房/买设备/技改/研发可以，借新还旧、买地、理财炒股、买楼买车都不行（负面清单制），用途写在合同里；③制造业贷款必须是固定资产贷款并投向省内，高企则要求主营业务在鼓励类目录、研发用途贷款别超加计扣除申报额；④先到先得——年度 2000 亿总额度用完即止，越早贷款越稳；⑤2026 年 5 月起央地可以叠加——享受了中央设备更新贷款贴息的新发放贷款也能再吃省里这份（合计不超利息总额），经办银行也多了 4 家异地城商行和外资金融机构。同一笔贷款仍不能同时享受省级其他贴息（如专精特新贴息）。深圳企业不适用（深圳自定政策）。"
  }
