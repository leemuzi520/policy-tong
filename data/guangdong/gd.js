...
window.ZCT_DATA.guangdong.push(
  ...
  },
  {
    ...
    conditions: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "项目技术就绪度 3～6 级起步，完成时应达 7～9 级，原则上提高 3 级以上", required: true, weight: 2, description: "1312 号通知评审说明：技术创新就绪度支持 3～6 级项目、完成时应达 7～9 级、原则上应有 3 级以上提高（就绪度评价标准见附件 2，阳光政务平台查看）——须对照就绪度等级标准自评项目所处阶段", basis: { name: "粤科函资字〔2026〕1312 号评审说明", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" }, evidence: "技术就绪度自评材料（按附件 2 就绪度评价标准逐级对照）" },
          { name: "提出高质量知识产权目标（不以专利/论文数量简单作为目标）", required: true, weight: 2, description: "1312 号通知评审说明：知识产权评议应提出高质量知识产权目标，不以专利、论文数量简单作为目标（评议指引见附件 3）——项目申报书须明确核心知识产权产出规划", basis: { name: "粤科函资字〔2026〕1312 号评审说明", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" }, evidence: "高质量知识产权目标与产出规划（按附件 3 知识产权评议指引）" },
    ...
    materials: [
      { name: "项目申报书（阳光政务平台在线填报，含技术路线图、就绪度自评、知识产权目标等）", required: true, basis: { name: "粤科函资字〔2026〕1312 号申报方式", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
      ...
      { name: "技术就绪度自评材料（按附件 2 就绪度评价标准）", required: true },
      { name: "知识产权评议相关材料（按附件 3 指引）", required: true }
    ],
    // 2026-08-14 修复：申报要求从诊断条件拆出（流程信息仅作提示展示，不进 conditions、不计分）
    diagNotes: [
      ...
      "评审论证：省科技厅组织第三方专业机构开展技术创新就绪度评估 + 知识产权评议 + 大数据查重与先进性分析（1312 号通知）",
