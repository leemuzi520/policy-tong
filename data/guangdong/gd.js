    ...
    conditions: [
      {
        ...
        items: [
          { name: "广东省内注册、生产经营的工业企业", required: true, weight: 3, description: "第十一条（三）+ 珠海 2026 通知：项目单位为制造业企业，依法登记注册且在广东省生产经营、经营活动正常、财务状况良好、不存在重大经营风险", basis: { name: "细则第十一条（三）· 珠海 2026 通知测算项目条件", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" }, autoMatch: "type", rule: () => true }, // 表单四种企业类型均为依法设立的企业，此条件自动通过；未选类型时归为未核验
          { name: "项目单位主营业务为制造业（国民经济行业分类制造业行业）", required: true, weight: 3, description: "珠海 2026 通知测算项目条件 2：项目行业类型属国民经济行业分类（GB/T4754-2017）「制造业」行业，项目单位主营业务须为制造业；项目投资按规定纳入制造业投资统计", basis: { name: "珠海 2026 通知测算项目条件 2", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } },
          { name: "近三年无重大质量、安全、环保事故", required: true, weight: 3, veto: true, description: "第十一条（三）：项目单位近 3 年内在质量、安全、环保等方面未发生重大事故；珠海 2026 通知同口径（近 5 年来专项资金申报、管理、使用过程中无违法违规行为）", basis: { name: "细则第十一条（三）· 珠海 2026 通知测算项目条件 5", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" }, autoMatch: "accident", rule: v => v === "无" },
          { name: "非失信被执行人、非环保不良企业、非「信用中国（广东）」惩戒黑名单企业", required: true, weight: 3, veto: true, description: "第十一条（三）+ 珠海 2026 通知：项目单位不属于失信被执行人；项目申报至公示期满期间不属于环保信用评价「环保不良企业」及「信用中国（广东）」失信惩戒黑名单企业", basis: { name: "细则第十一条（三）· 珠海 2026 通知测算项目条件 5", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } },
          { name: "未获得过省重大制造业项目投资奖励支持", required: true, weight: 2, veto: true, description: "第十一条（一）：测算项目未获得过省重大制造业项目投资奖励的支持", basis: { name: "细则第十一条（一）", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" } },
          { name: "项目及申报奖励的固定资产投资未获得过省工业和信息化领域财政资金支持", required: true, weight: 2, veto: true, description: "珠海 2026 通知测算项目条件 6：项目及申报奖励的固定资产投资未获得过省工业和信息化领域财政资金的支持；细则第十四条（二）同口径（资金不得用于已获省级财政资金支持过的固定资产）", basis: { name: "珠海 2026 通知测算项目条件 6 · 细则第十四条（二）", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } }
        ]
      },
      {
        category: "项目条件（实施细则第十一条（二）· 珠海 2026 通知）",
        items: [
          { name: "项目已取得投资主管部门核准、审批和备案等立项文件", required: true, weight: 3, description: "珠海 2026 通知测算项目条件 1：项目实施地在申报地市境内，并已取得投资主管部门核准、审批和备案等立项文件", basis: { name: "珠海 2026 通知测算项目条件 1", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } },
          { name: "投资门槛：珠三角核心 8 市立项和「十四五」期间完成总投资 ≥10 亿元、粤东西北 12 市 ≥5 亿元", required: true, weight: 3, description: "第十一条（二）：广州、珠海、佛山、惠州、东莞、中山、江门、肇庆市制造业项目立项和「十四五」期间完成总投资须 10 亿元以上；汕头、韶关、河源、梅州、汕尾、阳江、湛江、茂名、清远、潮州、揭阳、云浮市须 5 亿元以上；项目建设地发生变更的，按项目最终实际建设地申报条件和标准执行", basis: { name: "细则第十一条（二）", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" } },
          { name: "项目不存在多头或重复申报", required: true, weight: 2, description: "珠海 2026 通知测算项目条件 5：项目不存在多头或重复申报的情形；项目应符合国家和省相关发展建设规划、产业政策、市场准入标准及环保、节能、安全、土地等有关政策法规要求", basis: { name: "珠海 2026 通知测算项目条件 5", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } }
        ]
      },
      {
        category: "奖励口径（实施细则第十、十二、十四条 · 2026 年清算口径）",
        items: [
          { name: "奖励核算：按 2021-01-01 至 2025-12-31 新增实际固定资产投资额 ≤2%", required: false, weight: 3, description: "第十条、第十二条：对 2021-01-01 至 2025-12-31 期间符合条件的制造业项目新增实际固定资产投资额，省财政按不超过 2% 的比例核算奖励资金额度、对地级以上市政府事后奖励；2026 年清算口径——本次申请清算奖励额 = 2021-2025 年累计实际固定资产投资额 × 2% − 累计已下达奖励资金（多退少补，珠海 2026 通知）", basis: { name: "细则第十条、第十二条 · 珠海 2026 通知支持方式及标准", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" } },
          { name: "投资额口径：土地资产、非生产性交通运输设备、固定资产形成税款不计入", required: false, weight: 1, description: "珠海 2026 通知：土地资产和非生产性交通运输设备不计入测算和奖励范围，因固定资产投资形成的税款不计入；申请奖励的固定资产投资额以发票等合法票据时间为准、票据不含税，遵循发票金额与付款金额从小原则，发票开票时间、进口设备海关进口报关单时间须在 2021-01-01 至 2025-12-31 期间", basis: { name: "珠海 2026 通知 · 投资额口径", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } }
        ]
      },
      {
        category: "申报要求（2026 年通知工作程序）",
        items: [
          { name: "数字工信平台线上申报 + 纸质材料报属地工信部门", required: true, weight: 1, description: "珠海 2026 通知：申报及五年投资清算材料须于 2026-08-03 前在广东省工业和信息化厅「数字工信」平台（gdii.gd.gov.cn/szgx/）在线提交；纸质版一式两份、光盘一式两份于 2026-08-03 18:00 前递交至所在区（功能区）工信部门，各区 8-05 前正式行文报市工信局", basis: { name: "珠海 2026 通知 · 网上申报要求", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } },
          { name: "配合专家评审与现场核查（测算项目 ≠ 支持项目 ≠ 最终获得资金）", required: true, weight: 1, description: "实施细则第三条、第十五条、第十八条：测算项目仅用于测算投资奖励资金额度，不等同于支持项目；支持项目按资金使用范围经地市政府评审遴选后予以支持；全面实行项目库管理，未纳入项目库的项目原则上不安排预算；以测算项目核算的奖励额度仅作编制预算参考，不等同于最终安排的资金额度", basis: { name: "细则第三条、第十五条、第十八条", url: "https://gdii.gd.gov.cn/gkmlpt/content/3/3953/mmpost_3953652.html" } },
          { name: "配合「十四五」五年投资清算（未达投资门槛将收回奖励资金）", required: false, weight: 1, description: "实施细则第十三条：政策实施期满后根据测算项目「十四五」期间投资完成情况进行清算，未按规定完成投资的纳入台账管理的测算项目所获取的投资奖励资金由省财政予以清算收回；珠海 2026 通知：政策实施期内项目实际总投资未达 10 亿元的，市财政将以该项目为依据获得的全部投资奖励资金予以回收", basis: { name: "细则第十三条 · 珠海 2026 通知五年投资清算", url: "https://www.zhuhai.gov.cn/gxj/gkmlpt/content/3/3919/post_3919196.html" } }
        ]
      }
    ],
    ...
    conditions: [
      {
        ...
        items: [
          { name: "广东省境内（不含深圳市）依法注册、独立承担民事责任", required: true, weight: 3, description: "第七条（一）：在广东省境内（不含深圳市）依法注册，具有独立承担民事责任的能力；第二条认定范围为广东省境内（不含深圳市）——深圳市企业不在本政策认定范围，需人工确认注册地", basis: { name: "6 号文第二条、第七条（一）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "已建立企业技术中心并正常运作一年以上", required: true, weight: 2, description: "第七条（一）：已建立企业技术中心并正常运作一年以上；以技术中心成立文件、组织架构及运行记录核实", basis: { name: "6 号文第七条（一）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          ...
          { name: "专职研发人员 ≥50 人（建筑业企业 ≥60 人）", required: true, weight: 2, description: "第七条（五）：企业专职研究与试验发展人员数不少于 50 人（建筑业企业不少于 60 人）；表单无研发人员数字段，需人工按研究与试验发展人员统计口径核实（职工花名册、社保等佐证）", basis: { name: "6 号文第七条（五）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "技术开发仪器设备原值及研发用软件购置费 ≥800 万元（建筑业企业 ≥1000 万元）", required: true, weight: 2, description: "第七条（六）：企业技术开发仪器设备原值及研发用软件购置费不低于 800 万元（建筑业企业不低于 1000 万元）；表单无设备原值字段，需人工按资产台账核实", basis: { name: "6 号文第七条（六）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
      ...
      },
      {
        ...
        items: [
          { name: "技术中心组织体系健全、管理规范，与高校或科研院所建立稳定合作渠道", required: true, weight: 2, description: "第七条（二）：企业技术中心组织体系健全，管理规范，发展规划和发展目标明确，与高校或科研院所建立稳定的合作渠道；以产学研合作协议、技术中心管理制度与规划文件核实", basis: { name: "6 号文第七条（二）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "拥有自主知识产权的核心技术和品牌", required: true, weight: 2, autoMatch: "ipr", rule: v => v === "0" ? false : undefined, description: "第七条（二）：创新成果显著，知识产权管理水平较高，拥有自主知识产权的核心技术和品牌；表单知产档「无」明确不满足，1 件及以上是否构成核心技术与品牌需人工核实", basis: { name: "6 号文第七条（二）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "技术标准体系完善，能将科技成果及时转化为技术标准", required: true, weight: 1, description: "第七条（二）：技术标准体系完善，能将科技成果及时转化为技术标准；以标准制定/参与文件核实", basis: { name: "6 号文第七条（二）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } }
        ]
      },
      {
        category: "认定程序（6 号文第九条 · 便函〔2025〕562 号）",
        items: [
          { name: "数字工信平台网上申报 + 纸质材料报送属地工信部门", required: true, weight: 1, description: "便函〔2025〕562 号（2025 年第 24 批通知）：纸质申报与网上申报相结合——登录「广东省数字工信平台」（gdii.gd.gov.cn/szgx/ywtb-gzc/cms/index）在线提交，地市初审通过后从系统导出带水印最终版打印盖章报送；申报材料含认定及数据表、承诺书、申请报告、营业执照、统计局 107-1/107-2 表、上年度财务审计报告（须有备案二维码）、完税证明、技术中心成立证明等", basis: { name: "便函〔2025〕562 号 · 材料要求与申报方式", url: "https://gdii.gd.gov.cn/gkmlpt/content/4/4681/mpost_4681782.html" } },
          { name: "经地市工信部门初审推荐（超过时限不再受理）", required: true, weight: 1, description: "第九条（二）：地市工信主管部门对申请材料的符合性、完整性、有效性初审后，在规定时限内报送推荐名单及申请材料，超过规定时限原则上不再受理；2025 年第 24 批：地市 7 月 8 日 18 时前完成初审、7 月 10 日前推荐上报", basis: { name: "6 号文第九条（二）· 便函〔2025〕562 号", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "配合认定审核（书面评审/现场核查/陈述答辩）", required: false, weight: 1, description: "第九条（三）：省工信厅委托省级企业技术中心认定职能转移承接单位（广州赛宝认证中心服务有限公司）根据需要采取书面评审、现场核查、陈述答辩等相结合的形式开展认定；省住房和城乡建设厅对建筑业企业认定结果出具意见", basis: { name: "6 号文第九条（三）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } }
        ]
      },
      {
        category: "运行评价与动态管理（6 号文第十、十六、十七条）",
        items: [
          { name: "获评后每两年接受运行评价（评价不合格将撤销资格）", required: false, weight: 1, description: "第十条：省工信厅原则上每两年组织一次运行评价；评价分四档——优秀（≥90 分）、良好（70-90 分）、合格（60-70 分）、不合格（<60 分或研发投入/人员/设备不达标）；第十六条（一）（二）：评价不合格、逾期未报送评价材料将撤销资格", basis: { name: "6 号文第十条、第十六条（一）（二）", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "已评为国家企业技术中心的企业可不参与省级评价", required: false, weight: 1, description: "第十条：现有省级企业技术中心且已评为国家企业技术中心所在企业，可不参与省级评价，按国家企业技术中心运行评价要求管理并报送结果；被撤销国家企业技术中心资格的仍需参加省级评价", basis: { name: "6 号文第十条", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } },
          { name: "获评后按期申报变更、避免撤销情形（虚假材料/严重违法失信/重大安全事故三年内不得再申请）", required: false, weight: 1, description: "第十五条：地市每年审核省级企业技术中心所在企业更名、重组等变更情况并汇总上报；第十六条：提供虚假材料和数据、严重违法失信、重大质量/生产安全/环境安全事故等撤销资格；第十七条：因虚假材料、违法失信、安全事故被撤销的三年内不得再次申请", basis: { name: "6 号文第十五、十六、十七条", url: "http://www.luhe.gov.cn/swlhkgxj/gkmlpt/content/0/922/post_922229.html" } }
        ]
      }
    ],
    ...
    conditions: [
      {
        ...
        items: [
          { name: "广东省内注册登记且主要科研场所设在广东省内（企业/高校/科研机构/医院等法人单位）", required: true, weight: 3, description: "第八条：申报单位须为广东省注册登记的企业、高校、科研机构、医院等法人单位，主要科研场所设在广东省内；1523 号通知申报对象同口径。表单四种企业类型均为依法设立的企业，此条件自动通过", basis: { name: "12 号文第八条 · 1523 号申报对象", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" }, autoMatch: "type", rule: () => true }, // 表单四种企业类型均为依法设立的企业，此条件自动通过；未选类型时归为未核验
          { name: "上一年度主营业务收入 ≥5000 万元", required: true, weight: 3, autoMatch: "revenue", rule: v => v === "5000万-1亿" || v === "1亿-4亿" || v === ">4亿" ? true : v === "<500万" || v === "500万-2000万" || v === "2000万-5000万" ? false : undefined, description: "第九条（一）：企业上一年度主营业收入原则上不低于 5000 万元；「2000万-5000万」档明确低于 5000 万门槛不满足", basis: { name: "12 号文第九条（一）· 1523 号单位规模", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "上一年度研发经费 ≥主营业务收入 3%（研发经费超 3000 万元不受比例限制）", required: true, weight: 3, autoMatch: "rd", rule: v => v === "3%-5%" || v === "5%-8%" || v === ">8%" ? true : v === "<3%" ? false : undefined, description: "第九条（一）：企业上一年度研发经费不低于主营业务收入的 3%，研发经费超过 3000 万元的，不受该比例限制；表单研发占比档 ≥3% 判达标，研发经费 >3000 万豁免比例的金额口径表单无字段，需人工按审计报告核实", basis: { name: "12 号文第九条（一）· 1523 号单位规模", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "建有专门研发机构，本领域自主知识产权 ≥5 项且近三年获得 ≥3 项", required: true, weight: 3, autoMatch: "ipr", rule: v => v === "0" ? false : undefined, description: "第九条（二）：建有专门研发机构，研究方向和技术领域明确，本领域自主知识产权不少于 5 项；1523 号（三）科研成果口径：拥有 5 项（含）以上自主知识产权，且近三年获得的知识产权不少于 3 项。表单知产档「无」明确不满足；1 件及以上是否达到 5 项及近三年新增 3 项需人工按证书数量与时间核实", basis: { name: "12 号文第九条（二）· 1523 号科研成果", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "研发设备原值 ≥300 万元（不含生产设备）", required: true, weight: 2, description: "第九条（三）：有相对集中的工程试验用房和场地，具备开展工程化研发、设计和试验的综合能力，研发设备原值原则上不低于 300 万元；1523 号（二）：用于实验、检测、分析、试验的研发设备（不含生产设备）原值不低于 300 万元。表单无设备原值字段，需人工按资产台账核实", basis: { name: "12 号文第九条（三）· 1523 号科研条件", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "专职科研人员珠三角 ≥20 人、粤东西北 ≥10 人（本科以上学历或中级以上职称 ≥50%）", required: true, weight: 2, description: "第九条（四）：工程技术队伍中的专职科研人员数，珠三角地区申报单位不少于 20 人，粤东西北地区不少于 10 人；1523 号（二）：具有本科（含）以上学历或中级（含）以上职称的人员不低于专职科研总人数的 50%。表单无人员字段，需人工按花名册、社保、学历职称佐证核实", basis: { name: "12 号文第九条（四）· 1523 号科研条件", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "原则上已建有市（区）级及以上科研平台", required: true, weight: 2, description: "第九条前置：申报单位原则上已建有市（区）级及以上科研平台，科研管理体制和运行机制比较完善；1523 号（四）体制机制同口径（具有完善的管理架构和运行管理机制，有健全的研发体系和人才激励、知识产权管理等制度）。以平台认定文件核实", basis: { name: "12 号文第九条 · 1523 号体制机制", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "未列入联合惩戒对象名单，近三年无重大环保、安全等责任事故及学术诚信问题", required: true, weight: 3, veto: true, autoMatch: "accident", rule: v => v === "无", description: "第九条（五）（六）：未因严重违法失信行为被司法、行政机关依法列入联合惩戒对象名单；近三年未发生重大环保、安全等责任事故，未出现严重学术诚信问题；1523 号（六）同口径并新增工程中心主任近三年无科研失信记录、未受过刑事处罚（需人工核验）。表单口径「近三年无重大事故（含经营异常/失信/重大违法违规）」覆盖事故与失信，选「无」判满足、选「有」从严判不满足", basis: { name: "12 号文第九条（五）（六）· 1523 号其他条件", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } }
        ]
      },
      {
        category: "科研条件与体制机制（1523 号（二）（三）（四））",
        items: [
          { name: "具备科技成果转化能力，能开展工程化研发、设计和试验", required: true, weight: 2, description: "第九条（二）：研究方向和技术领域明确，具备科技成果转化能力；1523 号（二）：具备进行工程化研发、设计和试验的综合能力。以建设方案、转化案例、检测试验记录核实", basis: { name: "12 号文第九条（二）· 1523 号科研条件", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "工程中心主任为全职科技人员、入职依托单位 ≥3 年，近三年无科研失信记录、未受过刑事处罚", required: true, weight: 2, description: "1523 号（二）（六）：工程中心主任入职依托单位的时间不低于 3 年；近三年未有科研失信行为记录、未受过刑事处罚；12 号文第十二条：工程中心主任应由依托单位具有较高影响力和较强组织管理能力的全职科技人员担任。以主任简历、劳动合同、社保及任职文件核实", basis: { name: "1523 号科研条件、其他条件 · 12 号文第十二条", url: "https://gdstc.gd.gov.cn/gkmlpt/content/4/4755/post_4755191.html" } },
          { name: "高校、科研机构、医院类申报单位：近三年牵头或参与省级及以上科研项目，与企业产学研标志性成果 ≥3 项", required: false, weight: 1, description: "1523 号（三）科研成果：申报单位为高校、科研机构、医院的，近三年须牵头或参与承担过本领域省级及以上科研项目，且与企业开展产学研合作形成的标志性成果不少于 3 项。企业类申报单位不适用此条", basis: { name: "1523 号科研成果", url: "https://gdstc.gd.gov.cn/gkmlpt/content/4/4755/post_4755191.html" } }
        ]
      },
      {
        category: "申报程序（1523 号 · 12 号文第十条）",
        items: [
          { name: "企业、科研院所、医院只能申报 1 个工程中心；已建有工程中心的单位原则上不再受理申报", required: true, weight: 2, description: "1523 号申报对象（二）：企业、科研院所、医院只能申报 1 个工程中心，已建有工程中心的单位原则上不再受理申报；高校在未建有工程中心的专业类可申报 1 个。以是否已获认定核实", basis: { name: "1523 号申报对象", url: "https://gdstc.gd.gov.cn/gkmlpt/content/4/4755/post_4755191.html" } },
          { name: "阳光政务平台（pro.gdstc.gd.gov.cn）在线申报、无纸化，不接收纸质材料", required: true, weight: 1, description: "1523 号申报程序（二）：采用在线申报、无纸化方式，不接收纸质申报材料——项目负责人登录广东省科技业务管理阳光政务平台按系统要求填写申报信息、分类上传相关附件材料并提交，经单位财务管理人员、单位负责人审核提交至主管部门完成系统申报", basis: { name: "1523 号申报程序", url: "https://gdstc.gd.gov.cn/gkmlpt/content/4/4755/post_4755191.html" } },
          { name: "经主管单位审核推荐（2025 年度推荐截止 2025-09-17 17:00）", required: true, weight: 1, description: "第十条：申报单位按申报指南要求申报，主管单位负责审核推荐；1523 号申报程序（三）：各级主管部门在阳光政务平台对申请材料进行审核、择优推荐；2025 年度各推荐单位网上审核推荐截止时间为 2025-09-17 17:00", basis: { name: "12 号文第十条 · 1523 号申报程序", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "配合形式审查与专家评审（依据专家评审意见择优确定，公示后认定）", required: false, weight: 1, description: "第十条：省科技厅会同专业机构开展评审工作，依据专家评审意见择优确定列入工程中心建设名单并进行公示；1523 号有关要求（三）：形式审查不合格的不予受理（材料不齐全、佐证材料未经第三方认证、内容前后不一致、命名不规范等）", basis: { name: "12 号文第十条 · 1523 号有关要求", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } }
        ]
      },
      {
        category: "运行管理（12 号文第十八-二十一条 · 178 号第三条）",
        items: [
          { name: "获评后及时在创新服务平台（www.gdetrc.net）注册备案，变更通过平台办理", required: false, weight: 1, description: "178 号第三条：工程中心实行网络化管理，相关信息发布及过程管理依托「广东省工程技术研究中心创新服务平台」（www.gdetrc.net）实施，2025 年度认定通过的工程中心须于 2026-02-13 前登录该平台注册备案；后续依托单位更名、所属地或工程中心主任变更及资格撤销等通过服务平台办理。12 号文第十六条：重大调整、重组须报主管单位审核、省科技厅备案", basis: { name: "178 号第三条 · 12 号文第十六条", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4850/post_4850285.html" } },
          { name: "每年 6 月 30 日前在服务平台提交上年度报告（年度报告制度）", required: false, weight: 1, description: "第十八条：工程中心执行年度报告制度，每年 6 月 30 日前按要求在服务平台提交上一年度报告；第二十一条（七）：未按要求提交年度报告，经提醒后 30 个自然日内仍未提交的，取消工程中心资格", basis: { name: "12 号文第十八条、第二十一条（七）", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } },
          { name: "配合定期评估（5 年一个评估周期；基本合格限期 1 年整改，不合格取消资格）", required: false, weight: 1, description: "第十九条：省科技厅委托专业机构定期评估，5 年为一个评估周期，每年按申报年份、分领域开展，重点评估运行情况、研发条件、科研能力、建设成效；第二十条：评估结果分优秀、合格、基本合格、不合格 4 个等级，优秀纳入人才激励、融资贷款等政策扶持范围，基本合格限期 1 年整改；第二十一条（一）-（六）：逾期未参加定期评估、评估不合格、整改不合格、严重科研诚信问题、依托单位重大变故、重大安全环保责任事故等取消工程中心资格", basis: { name: "12 号文第十九条、第二十条、第二十一条", url: "http://gdstc.gd.gov.cn/gkmlpt/content/4/4067/post_4067201.html" } }
        ]
      }
    ],
    changesTitle: "2025 年度申报要点",
    ...
    conditions: [
      {
        ...
        items: [
          { name: "牵头单位为广东省内注册的独立法人单位（企业/科研院所/高校/事业单位/行业组织；港澳高校科研机构可参与）", required: true, weight: 3, description: "1312 号通知申报要求：牵头申报单位须为省内注册、具有独立法人资格的企业、科研院所、高校、其他事业单位和行业组织，以及港澳特区高等院校和科研机构。表单四种企业类型均为依法设立的企业，此条件自动通过；科研院所/高校牵头需在自诊断中核实", basis: { name: "粤科函资字〔2026〕1312 号", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" }, autoMatch: "type", rule: () => true },
          { name: "无科研失信记录、未列入社会信用「黑名单」，负责人无逾期未验收省级项目", required: true, weight: 3, veto: true, description: "1312 号通知禁止申报情形：存在科研失信或社会信用「黑名单」等记录的不得申报；项目负责人有 3 项以上省级项目未完成验收、有项目逾期一年未验收或当年度已申报 2 项的不得申报；有在研省重大科技专项或重点领域研发计划项目未验收的不能再任负责人", basis: { name: "粤科函资字〔2026〕1312 号禁止申报情形", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" }, autoMatch: "accident", rule: v => v === "无" },
          { name: "同一法人单位（高校除外）同一专项牵头及参与原则上不超过 3 项", required: true, weight: 2, description: "1312 号通知限项规则：同一法人单位（高校除外）在同一专项中牵头及参与原则上不超过 3 项；近三年年均研发费用不低于 5000 万元的高新技术企业可放宽至牵头及参与不超过 6 项（其中牵头不超过 2 项）——需人工核对本单位在研/已报项目数", basis: { name: "粤科函资字〔2026〕1312 号限项规则", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } }
        ]
      },
      {
        category: "项目条件（1312 号通知申报要求）",
        items: [
          { name: "产学研联合申报：同一项目牵头+参与单位总数原则上不超过 5 家", required: true, weight: 2, description: "1312 号通知：鼓励产学研联合申报，原则上同一项目牵头单位与参与单位总数不超过 5 家；牵头单位原则上应分配最大财政资金份额，省外企业不参与分配财政资金", basis: { name: "粤科函资字〔2026〕1312 号", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "项目技术就绪度 3～6 级起步，完成时应达 7～9 级，原则上提高 3 级以上", required: true, weight: 2, description: "1312 号通知评审说明：技术创新就绪度支持 3～6 级项目、完成时应达 7～9 级、原则上应有 3 级以上提高（就绪度评价标准见附件 2，阳光政务平台查看）——须对照就绪度等级标准自评项目所处阶段", basis: { name: "粤科函资字〔2026〕1312 号评审说明", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "提出高质量知识产权目标（不以专利/论文数量简单作为目标）", required: true, weight: 2, description: "1312 号通知评审说明：知识产权评议应提出高质量知识产权目标，不以专利、论文数量简单作为目标（评议指引见附件 3）——项目申报书须明确核心知识产权产出规划", basis: { name: "粤科函资字〔2026〕1312 号评审说明", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "企业牵头项目自筹经费原则上不低于总投入的 70%（未明确须企业牵头的 ≥50%）", required: true, weight: 2, description: "1312 号通知经费要求：指南明确须由企业牵头的，自筹经费原则上不低于总投入的 70%；未明确须企业牵头的，自筹经费原则上不低于 50%——需评估企业自筹资金能力", basis: { name: "粤科函资字〔2026〕1312 号经费要求", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "近三年年均研发费用不低于 5000 万元的高企（限项放宽条款，非申报门槛）", required: false, weight: 1, description: "1312 号通知限项规则：近三年年均研发费用不低于 5000 万元的高新技术企业，同一专项牵头及参与可放宽至不超过 6 项（牵头不超过 2 项）——普通企业按 ≤3 项执行", basis: { name: "粤科函资字〔2026〕1312 号限项规则", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } }
        ]
      },
      {
        category: "申报程序（1312 号通知）",
        items: [
          { name: "在线申报、无纸化：2026-07-22 至 08-21 17:00 通过阳光政务平台/省政务服务网提交", required: true, weight: 2, description: "1312 号通知申报方式：采用在线申报、无纸化方式，通过「广东省政务服务网」或「广东省科技业务管理阳光政务平台」（http://pro.gdstc.gd.gov.cn）查看指南并提交申报材料；确有不宜网络提交的可书面申请线下申报；立项后任务书纸质件另行通知报送", basis: { name: "粤科函资字〔2026〕1312 号申报方式", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "企业须上传上一年度企业所得税纳税申报表", required: true, weight: 1, description: "1312 号通知企业附加材料：企业牵头申报须上传上一年度企业所得税纳税申报表；牵头与参与单位存在关联关系的须如实说明", basis: { name: "粤科函资字〔2026〕1312 号", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } },
          { name: "竞争择优：同一方向有效申报不足 3 家视为竞争性不足、不进入评审；达 3 家及以上原则上只立项支持 1 项", required: true, weight: 1, description: "1312 号通知评审及立项说明：同一方向有效申报不足 3 家视为竞争性不足，不进入评审并不予立项；达 3 家及以上的，经评审后原则上只立项支持 1 项——立项不确定性高，申报前先评估细分方向竞争格局", basis: { name: "粤科函资字〔2026〕1312 号评审及立项说明", url: "http://gdstc.gd.gov.cn/zwgk_n/tzgg/content/post_4927741.html" } }
        ]
      }
    ],
