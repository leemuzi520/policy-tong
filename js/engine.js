...
if (!(window.ZCT_DATA?.national?.most?.length > 0 && window.ZCT_DATA?.national?.miit?.length > 0 && window.ZCT_DATA?.guangdong?.length > 0)) {
...
const COLUMNS = [
  ...
  { id: "zjzj", name: "专项资金与项目支持", desc: "省级财政专项资金：企业技术改造、绿色循环发展等事后奖励/贴息/补贴", countLabel: "2 条政策" }
];
