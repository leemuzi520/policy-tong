...
// ============================================================
const DATA_VERSION = '2026-08-15'; // 环境时钟口径：P1 修复日（断言补 city / region 封顶 / cert 键统一 / 紧迫提示单源 / kjxqy 批次补全）；同日第 2 批扩充（zhtiexi 37 / zhfund 38）+ zct-diag 深化 8 条（zhtech 2026 省市同批 / gdloan 12 号文央地叠加 / hzse 2026 公示等）
...
const COLUMNS = [
  { id: "zjt", name: "专精特新梯度培育", desc: "5 层梯度链条：创新型 → 省级专精特新 → 小巨人 → 重点小巨人/单项冠军（末两层并列方向；创新型与省级按广东省细则，粤工信规字〔2024〕5 号；单项冠军含国家级与广东省省级两级）", countLabel: "8 条政策 + 5 层链条" },
  ...
  { id: "zjzj", name: "专项资金与项目支持", desc: "财政专项资金：省级技改/绿色循环/先进制造奖补/专精特新贷款贴息 + 国家级超长期国债设备更新 + 中央预算内节能降碳投资补助", countLabel: "13 条政策" },
  { id: "gjpt", name: "企业创新平台", desc: "企业创新平台资质：国家/省级企业技术中心 + 国家技术创新示范企业 + 国家工程研究中心 + 国家级工业设计中心 + 省工程技术研究中心，研发投入高门槛 + 运行评价动态管理（39 号令 / 粤工信规字〔2022〕6 号 / 粤科规范字〔2022〕12号 / 发改委令第 34 号 / 工信部政法〔2023〕93 号）", countLabel: "7 条政策" },
...
// 材料清单：政策级官方 materials（2026-08-14 起，删除原「通用材料」硬编码清单——无官方依据、各政策差异大，一律以官方数据为准）
// 专项佐证：条件描述中含外部佐证关键词（报告/证明/证书/审计/检测等）的专项提示
